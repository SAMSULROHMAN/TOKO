...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(public/vendor/images/hero_1.jpg);" data-aos="fade">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="{{ asset('vendor/images/women.jpg')}}" alt="" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="{{ asset('vendor/images/children.jpg') }}" alt="" class="img-fluid">
              </figure>
              <div class="text">
                <span class="text-uppercase">Collections</span>
                <h3>Children</h3>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="{{ asset('vendor/images/men.jpg')}}" alt="" class="img-fluid">
              </figure>
              <div class="text">
                <span class="text-uppercase">Collections</span>
                <h3>Men</h3>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="{{ asset('vendor/images/blog_1.jpg')}}" alt="Image placeholder" class="img-fluid rounded"></a>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="{{ asset('vendor/images/hero_1.jpg')}}" alt="Image placeholder" class="img-fluid rounded mb-4">
